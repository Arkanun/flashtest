...
unsigned int SampleUtils::initShader(unsigned int shaderType, const char* source)
{
#ifdef USE_OPENGL_ES_2_0    
...
/*
void
SampleUtils::setRotationMatrix(float angle, float x, float y, float z, float *matrix)
{
...
void
SampleUtils::rotatePoseMatrix(float angle, float x, float y, float z, float* matrix)
{
    // Sanity check
    if (!matrix)
        return;
